...
import com.wavesplatform.transaction.{BlockchainUpdater, GenesisTransaction, SignedTx, Transaction, TxVersion}
...
class BlockV5Test
  ...
  private def createTx(sender: KeyPair, recipient: AddressOrAlias): Transaction =
    SignedTx.transfer(TxVersion.V1, sender, recipient, Waves, 10 * Constants.UnitsInWave, Waves, 100000, None, ntpTime.getTimestamp())
